...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div className={`absolute top-0 h-screen w-2/3 bg-gradient-2-tl from-white/10 to -[#483d8b] backdrop-blur-lg z-10 p-6 md:hidden smooth-transition ${mobileMenuOpen ? "left-0" : "-left-full"}`}>
        <img src={logo} alt="logo" className="w-full h-14 object-contain" />
